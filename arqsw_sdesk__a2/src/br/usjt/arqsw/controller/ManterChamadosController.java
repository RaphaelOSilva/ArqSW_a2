...
/**
 * 
 * @author Raphael de Oliveira Silva 816110743
 *
 */
@Controller
public class ManterChamadosController {
	private FilaService fs;
	private ChamadoService sc;
	
	@Autowired
	public ManterChamadosController(FilaService fs, ChamadoService sc) {
		this.fs = fs;
		this.sc = sc;
	}
	...
	public String listarChamadosExibir(@Valid Fila fila, BindingResult result, Model model) {
		try {
			...
			ArrayList<Chamado> chamados = sc.listarChamados(fila);
